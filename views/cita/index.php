...
<div id="app">
    <nav class="tabs">
        <button class="actual" type="submit" data-paso="1">Servicios</button>
        <button type="submit" data-paso="2">Informacion Cita</button>
        <button type="submit" data-paso="3">Resumen</button>
    </nav>
